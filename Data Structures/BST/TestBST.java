...
public class TestBST {
    public static void main(String[] args) {
        ...
        System.out.println("The tree should have 10 nodes and your tree has " + myTree.size() + " nodes.");
        ...
        System.out.println("The tree should have 9 nodes and your tree has " + myTree.size() + " nodes.");
        System.out.print("The in-order traversal of the tree should print the "
        ...
        System.out.println("The tree should have 5 nodes and your tree has " + myTree.size() + " nodes.");
        System.out.print("The in-order traversal of the tree should print the "
