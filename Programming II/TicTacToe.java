...
public class TicTacToe
{
	...
	static int A1, A2, A3, B1, B2, B3, C1, C2, C3;//1,2,3,4,5,6,7,8,9
	...
	public static void main(String[] args)
	{
      String line = "";
		System.out.println();
		line = " " + getXO(A1) + "A1|" + getXO(A2) + "A2| A3" + getXO(A3);
		System.out.println(line);
		System.out.println("-------------");
		line = " " + getXO(B1) + "B1|" + getXO(B2) + "B2| B3" + getXO(B3);
		System.out.println(line);
		System.out.println("-------------");
		line = " " + getXO(C1) + "C1|" + getXO(C2) + "C2| C3" + getXO(C3);
		System.out.println(line);
		System.out.println();
