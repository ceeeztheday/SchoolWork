...
public class TestRecursiveMethods {
    public static void main(String[] args) {
        ...
        System.out.println(
                "Test " + numTotalTests + ": sum(10, 20, 30, 40, 50, 60) ==> " + testResult + "\n Expected: 210");
        if (eMsg.equals("N/A"))
            System.out.println(" Yours: " + iReturn + "\n");
        else
            System.out.println(" Yours: " + eMsg + "\n");
        ...
        System.out.println(
                "Test " + numTotalTests + ": largest(10, 20, 30, 40, 50, 60) ==> " + testResult + "\n Expected: 60");
        if (eMsg.equals("N/A"))
            System.out.println(" Yours: " + iReturn + "\n");
        else
            System.out.println(" Yours: " + eMsg + "\n");
        ...
        System.out.println(
                "Test " + numTotalTests + ": largest(70, 20, 30, 40, 50, 10) ==> " + testResult + "\n Expected: 70");
        if (eMsg.equals("N/A"))
            System.out.println(" Yours: " + iReturn + "\n");
        else
            System.out.println(" Yours: " + eMsg + "\n");
        ...
        System.out.println(
                "Test " + numTotalTests + ": largest(70, 20, 100, 40, 50, 10) ==> " + testResult + "\n Expected: 100");
        if (eMsg.equals("N/A"))
            System.out.println(" Yours: " + iReturn + "\n");
        else
            System.out.println(" Yours: " + eMsg + "\n");
        ...
        System.out
                .println("Test " + numTotalTests + ": reverseStringRec(\"\") ==> " + testResult + "\n Expected: \"\"");
        if (eMsg.equals("N/A"))
        ...
        System.out.println(
                "Test " + numTotalTests + ": reverseStringRec(\"a\") ==> " + testResult + "\n Expected: \"a\"");
        if (eMsg.equals("N/A"))
            System.out.println(" Yours: \"" + sReturn + "\"\n");
        else
            System.out.println(" Yours: " + eMsg + "\n");
        ...
        System.out.println(
                "Test " + numTotalTests + ": reverseStringRec(\"abc\") ==> " + testResult + "\n Expected: \"cba\"");
        if (eMsg.equals("N/A"))
            System.out.println(" Yours: \"" + sReturn + "\"\n");
        else
            System.out.println(" Yours: " + eMsg + "\n");
        ...
        System.out.println(
                "Test " + numTotalBonusTests + ": reverseListRec(null) ==> " + testResult + "\n Expected: head->null");
        if (eMsg.equals("N/A"))
            System.out.println(" Yours: " + sReturn + "\n");
        else
            System.out.println(" Yours: " + eMsg + "\n");
