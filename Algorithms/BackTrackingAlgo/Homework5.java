...
public class Homework5 {
   ...
   // This is a recursive method that takes an int parameter (the starting queen
   // index)
   // and finds the first solution to the n-Queens problem.
   // Note that instead of using a for loop to print out the content of the col
   // array, you
   // are required to print out the complete chessboard and call the verifySolution
   // method
